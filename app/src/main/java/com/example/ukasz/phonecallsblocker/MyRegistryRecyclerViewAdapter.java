...
import com.example.ukasz.phonecallsblocker.RegistryFragment.OnListFragmentInteractionListener;
...
public class MyRegistryRecyclerViewAdapter extends RecyclerView.Adapter<MyRegistryRecyclerViewAdapter.ViewHolder> {
    ...
    public MyRegistryRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
